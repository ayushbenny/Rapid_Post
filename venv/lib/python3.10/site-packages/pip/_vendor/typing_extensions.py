    ...
    class _ProtocolMeta(GenericMeta):
            ...
            if tvars is not None:
                ...
                if gvars is None:
                    ...
                    if not tvarset <= gvarset:
                        ...
                        raise TypeError(
                            f"Some type variables ({s_vars}) are" f" not listed in {cls_name}[{s_args}]",
                        )
                    tvars = gvars
        ...
        def __instancecheck__(self, instance):
            ...
            if self._is_protocol:
                if all(
                    hasattr(instance, attr) and (not callable(getattr(self, attr, None)) or getattr(instance, attr) is not None)
